...
Five hands-on labs applying machine learning to network threat detection, using the UNSW-NB15 dataset. Built to accompany the AI Cybersecurity Masterclass, and shared here as public, runnable evidence of the work — not just slides.
...
5. **Model Comparison, Thresholds & Error Analysis** — compare Logistic Regression, Random Forest, and XGBoost, then move the decision threshold to see how missed attacks trade against false alarms.
...
Download the UNSW-NB15 dataset from the Cyber Range Lab at UNSW Canberra:

https://research.unsw.edu.au/projects/unsw-nb15-dataset

Place the prepared CSV files in `data/raw/`:
